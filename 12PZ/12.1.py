# І. Организовать и вывести последовательость из 20 целых чисел, 
# выбрать не повторяющиеся элементы, найти их количество. Элементы больше 5 увеличить в два раза.
import random
